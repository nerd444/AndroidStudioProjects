...
public class MainActivity extends AppCompatActivity {
    ...
    private String clientId = "see1n53b2f";
    private String clientSecret = "crlXyOuiKiJgtjraWmRp67VGpQdYvvHHcScOk3cC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 안드로이드 위치를 관리하는 객체가 LocationManager 이다.
        // 따라서 안드로이드 시스템에, 로케이션 서비스를 이앱이 사용하겠다고,
        // 로케이션 서비스를 요청하여, 로케이션매니저 변수에 저장해 줘야 한다.
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                GlideUrl glideUrl = new GlideUrl(url, new LazyHeaders.Builder().addHeader("X-NCP-APIGW-API-KEY-ID",clientId).addHeader("X-NCP-APIGW-API-KEY", clientSecret).build());
        ...
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,
                5000,   // 5초마다 위치갱신, 밀리세컨드, 1000:1초
                0,     // 10m 마다 위치갱신, 미터 10m
                locationListener);
